...
const (
	// DefaultDirMod default unix perms for usmgr directory.
	DefaultDirMod os.FileMode = 0755
	// DefaultFileMod default unix perms for usmgr files.
...
// MustUSmgrUser establishes current user identity or fail.
func MustUSmgrUser() string {
